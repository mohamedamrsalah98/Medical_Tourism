  ...
  useEffect(() => {
    ...
    axios.get(`http://127.0.0.1:8000/doctor/${ID}`, {
      ...
      .then(response => {
        ...
        treatment_id = response.data.treatment_center
    ...
    <div className="container" style={{ marginTop: '10%' }}>
      <div className="row shadow-lg p-3 mb-5 rounded" style={{ backgroundColor: "#c6ebe4" }}>
        ...
        <div className="col-lg-6 col-md-12  col-sm-12  mt-5">
          ...
          <h3 style={{ color: "#0e2b70" }}> <i className="fa-solid fa-sack-dollar me-2 text-success"></i> Cost :  {detail.price * 1.2}</h3>
